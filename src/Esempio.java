...
public class Esempio {
	...
	public static void main(String[] args) throws EccezioneUtenteInesistente {
		...
		UtenteRegistrato u4 = (UtenteRegistrato) s.cercaUtente(4);
		System.out.println(" "+u4.getCodice()+"; "+u4.getNome()+"; "+u4.getCognome()+"; "+u4.getEmail()+"; "+u4.getIndirizzo()+"; "+u4.getUsername()+"; "+u4.getPassword());
	}
